        ...
        <div class="modal-content">
            <form action="{{ route('barang.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="nama_barang" placeholder="Nama Barang" class="form-control mb-2">
                    <input type="text" name="jenis_barang" placeholder="Jenis Barang" class="form-control mb-2">
                    ...
                    <input type="number" name="harga_satuan" placeholder="Harga Satuan" class="form-control mb-2">
                </div>
        ...
        <div class="modal-content">
            <form action="{{ route('barang.update', $item->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="jenis_barang" value="{{ $item->jenis_barang }}" class="form-control mb-2">
                    <input type="number" name="stock" value="{{ $item->stock }}" class="form-control mb-2">
                    <input type="text" name="status" value="{{ $item->status }}" class="form-control mb-2">
                    <input type="number" name="harga_satuan" value="{{ $item->harga_satuan }}" class="form-control mb-2">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary">Save changes</button>
