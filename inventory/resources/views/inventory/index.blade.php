        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteBarangModal-{{ $item->id }}">Delete</button>
                </td>
            </tr>
            @endforeach
        </tbody>
...
<!-- Delete Modal -->
<div class="modal fade" id="deleteBarangModal-{{ $item->id }}" tabindex="-1" aria-labelledby="deleteBarangModalLabel-{{ $item->id }}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('barang.destroy', $item->id) }}" method="POST">
                ...
                <div class="modal-body">
                    Are you sure you want to delete {{ $item->nama_barang }}?
                </div>
                <div class="modal-footer">
